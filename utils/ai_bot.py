...
# A simple keyword-based response table that works offline
EXPERT_KNOWLEDGE = [
...
def setup_gemini():
    """Configure Gemini from the environment and return True if successful."""
...
def get_expert_response(user_msg):
    """Return a canned response if the message matches a known keyword, else None."""
    msg = user_msg.lower()
